// air-globe-lyapunov-2026/src/kernels.rs
// Lyapunov residuals for Air-Globe stability.
...
pub fn to_rj(measured: f64, bands: &CorridorBands) -> RiskCoord {
    ...
    RiskCoord {
        value: r,
        sigma: 0.0,  // Expand for sensor uncertainty in prod.
        bands: bands.clone(),
    }
}
...
// Invariant: Lyapunov check (decrease outside safe).
